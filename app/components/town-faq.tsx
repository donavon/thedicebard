...
export function TownFaq({ title, items }: TownFaqProps) {
  if (items.length === 0) {
    return null;
  }

  return (
    <section className="px-4 pb-24 pt-10 sm:px-6 lg:px-10 text-ink-blue">
      <div className="pt-6 mx-auto w-full max-w-4xl">
        <div className="rounded-[28px] border border-[#C9A476] bg-[#F3E2C6] px-6 py-10 shadow-[0_18px_30px_rgba(92,58,30,0.25)] sm:px-10">
