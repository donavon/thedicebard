export const frontmatter = {
  ...
  synopsis:
    "A quick, friendly guide to the words you will hear at the table so you can jump in with confidence.",
  author: "Rollick Carlberg West",
  date: "2026-02-09",
  imageUrl:
    "https://unsplash.com/photos/black-dice-on-white-table-Sv3DXPITy0U/download?force=true",
