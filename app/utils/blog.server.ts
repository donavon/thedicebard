...
export type ValidatedBlogPost = z.infer<typeof blogFrontmatterSchema>;
...
export function getValidatedBlogPosts() {
  return validatedBlogPosts;
}

export function getValidatedBlogPostBySlug(slug: string) {
  return validatedBlogPosts.find((post) => post.slug === slug);
}

export function getValidatedBlogPostLastmod(
